...
const inputClass =
  "rounded-[52px] border border-[#1053f3] px-[14px] text-[14px] outline-none focus:ring-2 focus:ring-[#1053f3]/30 transition h-[38px]";
...
export function ContactSection() {
  ...
  return (
    <section className="bg-[#f7f9ff] min-h-[697px] w-full relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute pointer-events-none" style={{
        ...
        background: "rgba(76,106,255,0.07)",
        filter: "blur(100px)",
      }} />

      <div className="relative max-w-[1440px] mx-auto w-full px-[233px] flex gap-[72px] items-center py-[85px]">
        ...
        >
          <h2
            className="text-[#1a1a1a] text-[36px] leading-[46px] tracking-[-0.36px] w-[410px]"
          ...
          <div className="flex flex-col gap-[27px] w-[332px]">
            {[
              ...
              >
                ...
                <p className="text-[14px] text-black leading-[23px] tracking-[-0.14px] w-[278px]"
        ...
        <motion.form
          ...
          className="bg-white border border-[#e3e3e3] rounded-[24px] w-[464px] px-[31px] py-[24px] flex flex-col gap-[20px]"
          initial={{ opacity: 0, x: 40 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true, amount: 0.3 }}
        ...
        >
          <div className="flex gap-[32px]">
            <div className="flex flex-col gap-[6px] w-[185px]">
              ...
              <input name="name" value={form.name} onChange={handleChange}
                className={`${inputClass} w-[186px]`} style={{ fontFamily: "Poppins, sans-serif" }} />
            </div>
            <div className="flex flex-col gap-[6px] w-[185px]">
          ...
          <div className="flex flex-col gap-[6px]">
            ...
            <input name="source" value={form.source} onChange={handleChange}
              className={`${inputClass} w-[403px]`} style={{ fontFamily: "Poppins, sans-serif" }} />
          </div>
          ...
          <div className="flex flex-col gap-[6px]">
            ...
            <textarea name="message" value={form.message} onChange={handleChange} rows={4}
              className="h-[114px] w-[403px] rounded-[18px] border border-[#1053f3] px-[14px] py-[10px] text-[14px] resize-none outline-none focus:ring-2 focus:ring-[#1053f3]/30 transition"
              style={{ fontFamily: "Poppins, sans-serif" }} />
          </div>

          <motion.button
            type="submit"
            className="bg-[#1053f3] text-white text-[18px] h-[43px] px-[32px] rounded-[32px] self-start relative overflow-hidden"
            style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600 }}
