...
export function ValueSection() {
  return (
    <section className="bg-white min-h-[686px] w-full relative overflow-hidden flex items-center justify-center">
      {/* Decorative blobs */}
      ...
      <div className="max-w-[1440px] mx-auto w-full px-[120px] flex justify-between py-[80px]">

        {/* Left: Heading + image */}
        <motion.div
          className="flex flex-col gap-[16px] max-w-[571px]"
        ...
        >
          <h2
            className="text-[#101010] text-[40px] leading-[1.3] tracking-[-1px] w-[571px]"
          ...
          <div className="relative mt-[32px]">
            <div className="w-[490px] h-[318px] rounded-[16px] overflow-hidden">
              <img src={imgImage1} alt="App feature" className="w-full h-full object-cover rounded-[16px]" />
            </div>
            {/* Floating payment badge */}
            <motion.div
              className="absolute bottom-[-20px] right-[60px] bg-white flex gap-[30px] items-center p-[16px] rounded-[16px] shadow-[20px_40px_80px_0px_rgba(45,51,81,0.12)]"
            ...
            >
              <div className="flex gap-[8px] items-center">
                <div className="size-[40px] rounded-full overflow-hidden border-[1.3px] border-white">
                  <img src={imgAvatar} alt="avatar" className="size-full object-cover" />
                </div>
                <div className="flex flex-col gap-[4px]">
                  <p className="text-[#1053f3] text-[20px]"
                    style={{ fontFamily: "Poppins, sans-serif", fontWeight: 700 }}>
                    Jalur Pay
                  </p>
                  <p className="text-[#757b8a] text-[14px]"
                    style={{ fontFamily: "Inter, sans-serif", fontWeight: 500 }}>
                    Mastercard ~ 0259
                  </p>
                </div>
        ...
        {/* Right: Feature list */}
        <div className="flex flex-col gap-[24px] pt-[69px]">
          {features.map((feat, i) => (
            <motion.div
              key={feat.title}
              className="flex gap-[24px] items-start px-[24px] py-[18px]"
              initial={{ opacity: 0, x: 40 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <motion.div
                className="bg-[#101010] rounded-full size-[56px] flex items-center justify-center shrink-0"
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <p className="text-[#757b8a] text-[14px] leading-[1.5] max-w-[360px]"
                  style={{ fontFamily: "Inter, sans-serif", fontWeight: 500 }}>
                  {feat.desc}
                </p>
              </div>
